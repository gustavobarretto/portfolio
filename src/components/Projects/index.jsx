                ...
                <div className="row projects-cards">
                    <div className="card" style={{width: "18rem"}}>
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://github.com/gustavobarretto/calculator-js-pure" className="btn btn-primary">Visit</a>
                        </div>
                    </div>
                    <div className="card" style={{width: "18rem"}}>
                        ...
                        <div className="card-body">
                            ...
                            <a href="https://github.com/gustavobarretto/countdown-js-pure" className="btn btn-primary">Visit</a>
                        </div>
                    </div>
                </div>
            </div>
